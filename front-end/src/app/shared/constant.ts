...
//read movie by genre
export const READ_MOVIE_BY_GENRE_ENDPOINT = 'http://localhost:3000/user/read/genre'


//read watchlist as well as watchlist
export const READ_WATCHLIST_ENDPOINT = 'http://localhost:3000/user/read/watchlist'
export const READ_FAVORITELIST_ENDPOINT = 'http://localhost:3000/user/read/favoritelist'
...
export const UPLOAD_THUMB_ENDPOINT = 'http://localhost:5000/thumb/'
